...
void registerServices() {
  ...
  getAndRegisterFirebaseStorageService();
...
MockFirebaseStorageService getAndRegisterFirebaseStorageService() {
  _removeRegistrationIfExists<FirebaseStorageService>();
  final service = MockFirebaseStorageService();
  locator.registerSingleton<FirebaseStorageService>(service);
  return service;
}
// @stacked-mock-create
